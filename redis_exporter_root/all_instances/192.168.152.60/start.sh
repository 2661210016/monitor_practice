...
curl -X PUT   -H "Content-Type: application/json"   -d @$WORKDIR/all_instances/192.168.152.60/redis-exporter-service.json   http://127.0.0.1:8500/v1/agent/service/register
